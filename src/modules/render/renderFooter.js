  ...
  container.insertAdjacentHTML('beforeend',
    ...
    <div class="footer__item footer__item_development footer-development">
      <ul class="footer-development__list">
        <li class="footer-development__item">Designer: <a class="footer__link" href="#">Anastasia Ilina</a></li>

        <li class="footer-development__item">Developer: <a class="footer__link" href="#">Palamarenko Eugenia</a>
        </li>
      </ul>
    </div>
  `
